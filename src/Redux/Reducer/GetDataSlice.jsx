...
export const getDataInfo = createAsyncThunk('getDataInfo', async ({ searchQuery, currentPage, pageSize }) => {
    try {
        const response = await axios.get(`https://react-redux-contactlist-backend.onrender.com/api/contacts/?searchQuery=${searchQuery}&currentPage=${currentPage}&pageSize=${pageSize}`,);
